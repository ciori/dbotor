...
# Usage: sudo ./connect_to_node.sh <OTHER_NODE_NAME>
...
ssh-keygen -t rsa -b 4096 -N '' -C "${NODE_NAME}-to-${OTHER_NODE_NAME}" -f ${DIR_PATH}/${NODE_NAME}/.ssh/ssh_key_${OTHER_NODE_NAME}
chown ${NODE_NAME}:${NODE_NAME} ${DIR_PATH}/${NODE_NAME}/.ssh/ssh_key_${OTHER_NODE_NAME}
chown ${NODE_NAME}:${NODE_NAME} ${DIR_PATH}/${NODE_NAME}/.ssh/ssh_key_${OTHER_NODE_NAME}.pub
...
cat ${DIR_PATH}/${NODE_NAME}/.ssh/ssh_key_${OTHER_NODE_NAME}.pub
echo ""
...
SOURCE="${DIR_PATH}/${NODE_NAME}"
KEY="${DIR_PATH}/${NODE_NAME}/.ssh/ssh_key_${OTHER_NODE_NAME}"
